...
> 原始日期: 2025-06-27 | 版本: V2_0611 hotfix v2
> **⚠️ 历史文档** — 本文档记录 6.25~6.27 的变更。后续修复见 `Current_Tuning_Guide.md`。
> **当前状态 (2026-07-08)**: ✅ 观测器已稳定工作，支持电压型 / Hybrid Active Flux 双模式。
...
| 日期 | 修复 | 文档 |
|------|------|------|
| 7.01 | VF 全部 Bug 修复 + InvProtect + 按键映射 + PI 优化 | `TODO_0611.md` 已修复列表 |
| 7.05 | 电流采样负号 + PI 限幅修正 | `Current_Tuning_Guide.md` |
| 7.08 | Hybrid Active Flux 观测器 + Vofa 9ch + Foc.h 清理 | `README.md` / `Observer_Debug_Guide.md` |
