...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, R_EN_Pin|L_EN_Pin|LCD_DC_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : R_EN_Pin L_EN_Pin LCD_DC_Pin */
  GPIO_InitStruct.Pin = R_EN_Pin|L_EN_Pin|LCD_DC_Pin;
